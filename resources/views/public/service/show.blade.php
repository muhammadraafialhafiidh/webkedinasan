    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            <div class="bg-white p-4 p-md-5 rounded-4 border shadow-sm">
                ...
                <h1 class="fw-bold text-primary-dark mb-3 text-break-word" style="font-family: 'Plus Jakarta Sans', sans-serif; font-size: 2rem; letter-spacing: -0.02em;">
                    {{ $service->title }}
                </h1>

                <div class="service-description service-html-content mb-4 text-dark" style="font-size: 1.05rem; line-height: 1.85;">
                    {!! $service->safe_description !!}
                </div>
                ...
                <div class="row g-3 mb-4 p-3.5 bg-light rounded-4 border">
                    <div class="col-md-4">
                        ...
                        <span class="fw-bold text-primary min-w-0 text-break-word d-inline-block"><i class="bi bi-clock me-1 text-warning"></i>{{ $service->duration ?? '-' }}</span>
                    </div>
                    <div class="col-md-4">
                        <small class="text-muted d-block fw-bold text-uppercase" style="font-size: 0.725rem; letter-spacing: 0.05em;">Biaya / Tarif</small>
                        <span class="fw-bold text-success min-w-0 text-break-word d-inline-block"><i class="bi bi-cash-stack me-1 text-success"></i>{{ $service->cost ?? '-' }}</span>
                    </div>
                    <div class="col-md-4">
                        ...
                        <span class="fw-bold text-dark min-w-0 text-break-word d-inline-block"><i class="bi bi-file-earmark-check me-1 text-info"></i>{{ $service->product ?? '-' }}</span>
                    </div>
                </div>
                ...
                @forelse($officers as $index => $pj)
                    <div class="{{ !$loop->last ? 'mb-4 pb-3 border-bottom' : '' }}">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-2">
                            <div class="bg-primary bg-opacity-10 text-primary p-2 rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width: 44px; height: 44px;">
                            ...
                            <div class="min-w-0 flex-grow-1">
                                ...
                                <span class="fw-bold text-dark fs-6 text-break-word">{{ $pj->nama }}</span>
                            </div>
                        </div>
